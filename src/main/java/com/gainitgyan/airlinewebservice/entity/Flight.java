...
public class Flight {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE , generator = "flight_jpa_seq_gen")
	@SequenceGenerator(name = "flight_jpa_seq_gen" , sequenceName = "flight_id_seq" , allocationSize = 1)
