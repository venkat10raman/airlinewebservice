...
public class JWTTokenUtil {
	...
	private void setCustomClaims(Map<String, Object> claims, UserPrincipal principal) {
		...
		//sga is SimpleGrantedAuthority
		principal.getAuthorities().stream().forEach(sga -> {
			authorityNameList.add(sga.getAuthority());
		});
		claims.put("authorities",authorityNameList);
